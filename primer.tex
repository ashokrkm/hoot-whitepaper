...
\begin{frame}[fragile]{Hoot peer to peer Network }
  ...
  \end{verbatim}
   ...
   Read our white paper for a detailed description on how the protocol will enable the creation of a completely decentralized live-streaming and zk distributed computing network, powered by decentralized micro payments using cryptocurrencies Bitcoins, ETH and blockchain. 
