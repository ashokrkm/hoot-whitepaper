...
\begin{adjustbox}{width=1\textwidth}
 ...
 \hline
 \includegraphics[scale=0.25]{./static/cent.png} & \includegraphics[scale=0.25]{./static/dec.png}\\
 % \midrule
 \hline
...
% 	\includegraphics[scale=.3]{./static/ipcn-p2p.pdf} Uber/Airbnb for computers
% \begin{itemize}
...
\includegraphics[scale=.4]{./static/ipcn-p2p.pdf}
IPCN™\textsuperscript{TM} Get the GPUCoin GPC tokens from
\includegraphics[scale=0.4]{./static/hootcoin.png} 
...
\emph{emphasize} text, \alert{accent.png} parts
or show \textbf{bold} results.\end{verbatim}

 \begin{center}becomes\end{center}

 The theme provides sensible defaults to \emph{emphasize} text,
 \alert{accent.png} parts or show \textbf{bold} results.
\end{frame}
