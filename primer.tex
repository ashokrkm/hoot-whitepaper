...
\subtitle{Open Source decentralized uncensorable Network allowing anyone to rent their excess network traffic and compute, while providing a secure compute connection for those who can use it}
\date{\today}
...
\begin{frame}[fragile]{Hootcoin peer to peer Ðapp Network }
  ...
  Hoot foundation is developing \href{https://onhoot.com/tokensale}{\textsc{Hoot Network} – an Open source software}, powering a Decentralized Network of live-streaming and distributed computing Nodes.
