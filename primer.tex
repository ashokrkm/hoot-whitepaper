...
\title{HOOT zk distributed computing future proof video protocol Ðapps platform powered by cryptocurrency Blockchain}
...
\begin{frame}[fragile]{Hoot GPUcoin peer to peer Ðapp Network }
...
\begin{frame}[fragile]{Hoot peer to peer Network }
 Hoot GPUcoin Network is based on a complex architecture revolving around P2P, Blockchain, Smart Contracts, State Channels, etc\ldots
 \begin{verbatim} 
...
\end{frame}
%--- Next Frame ---%
\begin{frame}[t]{Hoot GPUcoin Values}
% \newcolumntype{Y}{>{\centering\arraybackslash}X}
\input{values-table}
...
\includegraphics[scale=0.4]{static/hootcoin} Decentralized hoot nodes will earn crypto-token incentives called Hoot GPUcoins 
...
IPCN Get the Hoot GPUcoin tokens from
