...
\subtitle{Open Sourced Network allowing anyone to rent their unused Network traffic and compute, while providing a secure compute connection for who need it}
\date{\today}
