...
\begin{frame}[t]{IPCN: Interplanetary Compute Network}
	...
	\includegraphics[scale=0.2]{static/ipcn} Uber Airbnb for computers
\end{frame}
%--- Next Frame ---%
...
\includegraphics[scale=0.2]{static/hootcoin}     Decentralized hoot nodes will earn crypto-token incentives called HOOT Coins 
