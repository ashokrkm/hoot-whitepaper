...
\author{GPUcoin IPCN™\textsuperscript{TM} network protocol team}
...
\href{mailto:founders@gpuco.in}{founders@gpuco.in} 
 ...
 \end{center}
\begin{center}
\textbf{GPUCoin}: the biggest \textbf{protocol} ICO since File-coin, make \textbf{mining profitable}, increase \textbf{GDP} of the cryptocurrency market 
% to 1 Trillion \$\$
\end{center}
