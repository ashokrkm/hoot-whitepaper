...
\title{ GPUCoin ICO }
\subtitle{ Foundational GPU accelerated compute layer - Build future proof decentralized video, AI, VR, AR protocols on IPCN™\textsuperscript{TM}
 % or \texttrademark
...
\end{itemize}
 \pause
 \includegraphics[scale=0.1]{./static/hootcoin.png} 
...
\begin{frame}[t]\frametitle{Problem}
 % \includegraphics[width=0.95\textwidth]{./static/problem-architecture-trans.png}
 \includegraphics[width=0.95\textwidth]{./static/problem-architecture-trans-cmrfont.png}
...
% \includegraphics[scale=0.5]{./static/hoot-video-architecture-channel-trans.png}
 % \includegraphics[width=.95\textwidth]{./static/gpctokens-solution-trans-ai.png}
\includegraphics[width=.95\textwidth]{./static/gpctokens-solution-trans-ai-cmrfont.png}
...
\begin{frame}[t]\frametitle{GPUCoin ICO Token-sale time-line}
 \includegraphics[width=1.0\textwidth]{./static/gpc-tstimeline-trans.png}
\end{frame}
...
\includegraphics[scale=.3]{./static/ipcn-p2p.pdf}
IPCN™\textsuperscript{TM}: get the GPUCoin GPC tokens from
\includegraphics[scale=0.3]{./static/hootcoin.png} 
...
\href{mailto:founders@gpuco.in}{founders@gpuco.in} 
 ...
 \end{center}
\begin{center}
% \includegraphics[scale=0.2]{./static/GPUCoin-trans-256.png}
...
% \begin{tikzpicture}
% \node (img1) {\includegraphics[height=5cm]{./static/arad/arad1.png}};
% % \pause
% \node (img2) at (img1.south east) [xshift=-1cm] {\includegraphics[height=4cm]{./static/arad/arad3.png}};
% % \pause
% \node (img3) at (img2.south west) [xshift=-2cm,yshift=1cm] {\includegraphics[height=4cm]{./static/arad/arad2.png}};
% \pause
% \node (img4) {\includegraphics[height=2cm]{./static/arad/arad4.png}};
% % \pause
% \node (img5) at (img1.south east) [yshift=-1cm] {\includegraphics[height=4cm]{./static/arad/arad5.png}};
