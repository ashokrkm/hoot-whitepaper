...
\item p2p transfer of value, trustless computing, non-custodial exchanges, decentralized storage - basis for building Ðecentralized applications (Ðapps)

\end{itemize}
 \pause
 Ðapps still lack the ability to include streaming media \& data in an open \& decentralized way
...
Get the GPUcoin GPC tokens from
