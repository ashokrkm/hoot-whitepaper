...
\item GPUCoin will become the main currency for cryptocurrency \textbf{Miners} and save their excess investment when many blockchains become proof-of-stake following eth lead
\end{itemize}
...
\begin{frame}[fragile]{Hoot GPUcoin peer to peer GPU Ðapp Network }
 ...
 Hoot foundation is developing \href{http://gpuco.in/}{\emph{Hoot GPUCoin Network} – an Open source software}, powering a Decentralized Network of live-streaming \& distributed \textbf{GPU} computing p2p Ðapp Nodes.
