...
Video Ads have been charged historically based on CPM for impressions as it has been nearly impossible to know how much of these video ads lead to a sale/conversion or if they even positively affect the ROI. Viewers do not know what action to take and how to take the said action leaving them to figure out how to follow up on the video ad they just saw, leading to a lot of drop off and lack of performance of these video ads. Hence It’s not easy  to measure effectiveness and performance of the video ads historically.

Using interactive \emph{AR} augmented reality  ads with clear calls to Actions such as a buy button or rent button below the interactive AR ad, sales can be generated right then and there, after the viewer interacts with the AR ad. We will be able to charge based on sales generated from the AR interaction i.e., referrals and instead of charging based on CPM or impressions we can charge based on \emph{CPR} or cost per referral. By bringing about an innovative CPR based business model to video ads using Augmented reality call to actions we bring the effectiveness of Google AdWords to video ads that only used to perform as well as banner ads before. This leads to a quantum improvement in video AR adspend ROI much like AdWords improved the ROI of web based banner ads.
