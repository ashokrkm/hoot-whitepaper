...
Hootcoin Network is based on a complex architecture revolving around P2P, Blockchain, Smart Contracts, State Channels. Hootcoin network protocol will enable the creation of completely decentralized compute network, powered by decentralized micro payments. This leads to Uber for computers helping create IPCN an interplatenary compute network.
