...
\usepackage{listings}
\usepackage{float}
\title{GPUcoin decentralized uncensorable open source distributed computing protocol \& marketplace technical whitepaper}
...
Bet on the future with IPCN GCN mining, distributed computing protocol using GPUCoin for mining and decentralized distributed computing.
