...
\section{Blockstack, Token, Status and the beginnings of decentralized
  web}
 We are now entering a new era of De-Centralized applications, blockchain technologies collectively known as Web 3.0. Firefox, Chrome and IE have ruled the centralized web. decentralized technologies
such as Blockstack are ushering in the auspicious beginnings of
decentralized web. In the centralized web, the users are the product,
...
was estimated to be the carbon footprint of Bitcoin per year. These
