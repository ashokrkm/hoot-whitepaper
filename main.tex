...
We are quite excited by ARKit/ARCore that is going to be available in the
upcoming version of iOS11/Android respectively and believe that it is going to usher a
...
intelligent live video. We also envision an AR first OS,  an operating system native to virtual and augmented reality.
