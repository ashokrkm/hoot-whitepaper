...
In late 2013, 8.25 megatonnes (8,250,000 tonnes) of CO2 per year was estimated to be the carbon footprint of Bitcoin per year. These computers are consuming so much electricity that it’s already unprofitable to mine in some regions of the world. Since Hoot miners utilize their unused bandwidth and compute capacity towards a useful task of Streaming, encoding and security of video and audio streams, they are not wasteful in their resources. Since Hoot issues tokens to everyone corresponding to their comput irrespective of how 
