...
% To give an arbitrary example to illustrate this mechanism in action, imagine that the system mints new tokens daily. On day one, the market rate of 1 STC is 1 ETH. On day two, the market rate is 1 STC for 2 ETH. Because there was 100% growth, imagine 25% of the total amount of tokens in circulation are minted to capture some of that growth and distribute it fairly to the content creators who are responsible in large part for the growth of the economy. Imagine another 10% of the total amount of tokens in circulation are minted to reward the stakeholders who have staked their tokens to both vote on token distribution to content creators and to elect delegates in the delegated proof of stake (DPOS) system. Hence, 35% of the total growth is redistributed to those providing valuable services to the network, and 65% is retained. This is a system that has been pioneered and proven to function well by platforms such as Steem<sup>[5]</sup>, which has over 100,000 daily unique visitors<sup>[31]</sup> and extremely rapid user growth directly incentivized by such an ecosystem.
...
% Imagine another 15% of total tokens are minted, exchanged as volume becomes available at the current market value of 1 STC for 2 ETH, and then established as a price floor at the last measured price of 1 STC for 1 ETH. On the next day, when coins are scheduled to be minted again, all existing coins in the price floor fund can updated to sell at the new price floor price - in this case, at the price of 1 STC for 2 ETH. In this scenario, 50% of total growth is repurposed to help grow the network and provide benefits within the ecosystem, and 50% is retained.
