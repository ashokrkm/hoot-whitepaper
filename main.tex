...
\section{Blockstack, Toshi, Status and the beginnings of de-centralized
  web}
...
\section{Platform and video Appstore to support machine learning
  Augmented reality and other v-apps}
...
\section{Auction to find optimal price}
...
\emph{including} amendments to the auction amendment procedure itself. Upgrades to Hoot auction protocol are staged through a testing environment to allow stake-holders to recall potentially inferior amendments, that lead to sub-optimal pricing for network stakeholders. 
