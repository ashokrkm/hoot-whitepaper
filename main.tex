...
to ensure strong security. The live connection is encrypted using AES_256_CBC, with HMAC-SHA1 for message authentication and DHE_RSA as the key exchange mechanism. Every RTMP player connection is authenticated with an RTMPE/ RTMPS
