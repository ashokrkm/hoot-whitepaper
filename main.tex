...
\usepackage{listings}
\usepackage{float}
\title{Hoot de-centralized censorship open source Live Streaming Protocol and Marketplace Technical Whitepaper}
\author{Hoot Author}
\date{July 26 2017}
...
Streaming services which is based on blockchain technology and a new
...
to be built. This would enable true zero knowledge live-streams in
