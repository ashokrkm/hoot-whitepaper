...
\subsection{Performant Augmented Reality ads with ROI }
Video ads have been charged historically based on CPM for impressions as it has been nearly impossible to know how much of these video ads lead to a sale or if they even positively affect the ROI. it’s not easy  to measure effectiveness and performance of these video ads. Also Viewers don’t know what action to take and how to take leaving them to figure out how to follow up on the video ad they just saw, leading to a lot of drop off and lack of performance.
Using interactive ar augmented reality  ads with clear calls to Actions such as a buy button or rent button above or below the interactive ar ad sales can be generated right then and there. We are able to now charge based on sales generated from the ar interaction ie referrals and instead of charging based on cpm or impressions we can charge based on cpr or cost per referral. By bringing about a cpr based business model we bring the effectiveness of google AdWords to video ads that only used to perform as well as banner ads. This leads to a quantum improvement in video ar adspend roi much like AdWords improved the roi of banner ads.
