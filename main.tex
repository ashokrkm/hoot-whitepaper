...
\item[-] Entertainment systems are designed to benefit the select few
  in Hollywood, most artists, musicians and creators have little or no access to the monetary
...
\item[-] Most video and live systems are centralized subject to
  ...
  share their free speech openly
\item[-] As the systems to deploy video and live are expensive and
  centralized there has been a significant lack of innovation.
...
\item[-] By making the video system decentralized and uncensorable, Hoot promotes
  citizen free speech without risk of detection and censorship
...
\item[-] By making the platform opensource and decentralized over the
  ...
  payment channel is a common means of censorship e.g., the 
  paypal account and banking account belonging to  Wikileaks was blocked by various central controlling organizations.
\end{itemize}
...
\fi
Hoot can instantiate any blockchain based protocol. Its seed protocol specifies a procedure for stakeholders to approve amendments to the protocol,
...
\begin{itemize}
  \item{having no centralized points of failures - byzantine fault tolerant p2p network}
