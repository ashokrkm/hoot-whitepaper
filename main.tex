...
An example livestreaming application has been built and is live on the itunes appstore with 3 million users and android play store and the web. This is a low latency consumer streaming application that leverages the GPUCoin IPCN network serving as a good example of what GPU accelerated network can provide in terms of superior low latency user experience.
