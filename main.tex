...
to ensure strong security. The live connection is encrypted using AES\_256\_CBC, with HMAC-SHA1 for message authentication and DHE\_RSA as the key exchange mechanism. Every RTMP player connection is authenticated with an RTMPE/ RTMPS
