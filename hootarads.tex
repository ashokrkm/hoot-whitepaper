...
\end{itemize}
\pause
Video ads are still \textbf{stuck in the banner ad dark ages pre-Google Adwords }
...
\pause
\item[*]clear \textbf{Calls to action} "Buy now" buttons can be programmatically added to the ad, eg., \emph{ Buy concert ticket to Rihanna event}
\end{itemize}
\end{frame}
%--- Next Frame ---%
...
\pause	
\item[+]Clear and engaging \textbf{call to actions} in video ads using AR
\pause
\item[+]Viewers \textbf{know} what to do after watching video by clicking call to action buy 
\pause
