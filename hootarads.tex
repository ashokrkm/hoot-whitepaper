...
\end{itemize}
\pause
Video ads are still \underline{stuck in the banner ad dark ages pre-Google Adwords }
...
\pause	
\item[+]Clear and engaging \underline{call to actions} in video ads using AR
\pause
