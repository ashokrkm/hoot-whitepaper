...
\end{frame}
%--- Next Frame ---%
\begin{frame}[t]{Hoot Augmented Reality ads \includegraphics[scale=.1]{./static/arad/arad5.png}} 
 \begin{itemize}[<+-| alert@+>]
...
% \pause
\includegraphics[scale=.15]{./static/arad/bitmoji.png} 
% (masquerade)
% \pause
...
\begin{frame}[fragile]{ BHAG Goal - Building Adwords of video \includegraphics[scale=.1]{./static/arad/arad5.png} }
\begin{itemize}[<+-| alert@+>]
...
\begin{frame}[standout]
 ...
 % \pause
 \node (img5) at (img1.south east) [yshift=-1cm] {\includegraphics[height=2.5cm]{./static/arad/arad5.png}};
