...
\begin{frame}[standout]
  ...
  % \pause
  \node (img2) at (img1.south east) {\includegraphics[height=4cm]{static/arad/arad2}};
  % \pause
  \node (img3) at (img2.south west) [yshift=3cm] {\includegraphics[height=4cm]{static/arad/arad3}};
  \end{tikzpicture}
